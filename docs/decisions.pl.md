...
**Decyzja:** Boss jest zawsze dostępny i przechodzi przez sześć poziomów, które utrzymują się mimo śmierci.
**Dlaczego:** Utrzymuje ścieżkę presji monotoniczną i odzwierciedla pięć śmierci Oliwiera z fabuły.
**Status:** Aktywna.
...
!!! note "Starsze wpisy"
    Oryginalny deck GDD pozostawił tę sekcję jako *„Treść wkrótce”*. Powyższe wpisy są zrekonstruowane z decyzji już widocznych na pozostałych stronach; dodawaj tu prawdziwe, datowane wpisy w miarę ich podejmowania, aby to stało się głównym zapisem.
